...
(function () {
  ...
  btn.setAttribute('aria-label', 'Open breakdown chat')
  btn.innerHTML =
    '<span style="display:inline-grid;place-items:center;width:28px;height:28px;border-radius:999px;background:#222b32;color:#0adc6a;font-weight:800;font-size:14px;margin-right:10px">R</span>Broke down? Get help now'
  btn.style.cssText =
