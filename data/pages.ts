...
export const products = {
  ...
  items: [
    ...
    },
    {
      ...
      primaryCta: { label: 'Request a repair', href: 'https://repair.bigrig.app' },
      secondaryCta: { label: `Call ${CALL_CENTER}`, href: CALL_CENTER_TEL },
    },
    {
      eyebrow: 'For owner-operators & drivers',
      ...
      primaryCta: { label: 'Get the Driver app', href: 'https://apps.apple.com/app/id1605615839' },
      secondaryCta: { label: 'Learn more', href: '/owner-operators' },
    },
    {
      eyebrow: 'For shops & mechanics',
      ...
      secondaryCta: { label: 'Learn more', href: '/shops' },
    },
  ],
  directory: {
    ...
    cta: { label: 'Browse the directory', href: 'https://www.bigrig.app/semi-truck-repair/' },
  },
}
